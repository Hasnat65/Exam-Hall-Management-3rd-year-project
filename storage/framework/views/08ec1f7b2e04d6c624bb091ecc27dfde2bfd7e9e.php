...
<a href="/home"><button class="btn " style="position:fixed;text-align:right" > Back </button></a>
...
<table>
    ...
    <?php $__currentLoopData = $names; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <tr>
        ...
        <td style="font-size:13px;padding-left:4px"><?php echo e($name->t_name); ?>,<?php echo e($name->dept_name); ?></td>
...
<p style="float: right;font-size: 13px;"><?php echo " <br>" ;include('raw.php'); echo "তারিখঃ ".bn_date(date('d-M-Y'));?></p>
...
<p style="margin-top: 0px;font-size:13px">বিঃদ্রঃ উল্লেখিত তালিকায় কোন ভুল ভ্রান্তি পরিলক্ষিত হলে তা সংশোধনযোগ্য</p>
</body>
</html>
